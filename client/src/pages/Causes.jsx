...
const causesData = [
  { id: 'seva', title: 'Project Seva', category: 'Health & Nutrition', desc: 'Providing nutritious meals and essential healthcare access to underprivileged communities.', stat: '5,000+ Meals/Month', color: 'bg-green' },
  { id: 'bachpanshala', title: 'Bachpanshala', category: 'Education', desc: 'Setting up informal learning centers for street children to integrate them into formal schooling.', stat: '1,200+ Students', color: 'bg-accent' },
  { id: 'jeev', title: 'Jeev', category: 'Animal Rescue', desc: 'Rescuing, treating, and rehabilitating stray animals in distress.', stat: '300+ Rescues', color: 'bg-primary' },
  { id: 'udaan', title: 'Udaan', category: 'Women Empowerment', desc: 'Vocational training and micro-finance support to help women become financially independent.', stat: '250+ Micro-businesses', color: 'bg-blue-500' },
  { id: 'prakriti', title: 'Prakriti', category: 'Sustainability', desc: 'Large-scale tree plantation drives and waste management awareness campaigns.', stat: '10,000+ Trees Planted', color: 'bg-emerald-600' },
  { id: 'vikas', title: 'Vikas', category: 'Skill Development', desc: 'Upskilling youth with digital literacy and employable skills for the modern job market.', stat: '800+ Placements', color: 'bg-orange-500' }
];
            ...
            {causesData.map((cause, index) => (
              ...
              >
                <div className="h-48 md:h-64 bg-dark/50 relative overflow-hidden group">
                  <div className={`absolute inset-0 opacity-20 group-hover:opacity-40 transition-opacity duration-500 ${cause.color}`}></div>
                  <div className="absolute inset-0 flex items-center justify-center text-light/20 font-display font-bold text-xl mix-blend-overlay">
                    [Photo: {cause.title}]
                  </div>
                </div>
